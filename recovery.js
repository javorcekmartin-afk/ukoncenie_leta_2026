// v46 – bootstrap cloudu + všetky predchádzajúce vrstvy + správne skutočné jednotky v súhrne nákupov.
(function(){
  if(!document.getElementById('cloudBootstrapScript')){
    const s=document.createElement('script');
    s.id='cloudBootstrapScript';
    s.src='cloud_bootstrap.js?v=46';
  ...
  function loadV46(){
    ...
    function loadShopActualUnits(){
      if(document.getElementById('v46ShopActualUnitsScript'))return;
      const x=document.createElement('script');
      x.id='v46ShopActualUnitsScript';
      x.src='v46_shop_actual_units.js?v=46';
      x.onload=()=>{document.title='Stánok v46';const pill=document.querySelector('.top .pill');if(pill)pill.textContent='v46';renderAll()};
    ...
    function loadManualItemActual(){
      ...
      x.src='v45_manual_item_actual.js?v=46';
    ...
    function loadProfitInventory(){
      ...
      x.src='v44_profit_inventory_summary.js?v=46';
    ...
    function loadOpenPackageTargets(){
      ...
      x.src='v43_open_package_targets.js?v=46';
    ...
    function loadCategoryProfit(){
      ...
      x.src='v42_category_profit_only.js?v=46';
    ...
    function loadPrepaid(){
      ...
      x.src='v40_prepaid_before_event.js?v=46';
    ...
    function loadAllItems(){
      ...
      x.src='v39_all_items_in_shopping.js?v=46';
    ...
    function loadSelectiveProfit(){
      ...
      p.src='v38_selective_product_profit.js?v=46';
    ...
    function loadTruthful(){
      ...
      t.src='v37_truthful_results.js?v=46';
    ...
    function loadPlannedCosts(){
      ...
      p.src='v35_planned_costs.js?v=46';
      p.onload=loadVat;
      document.body.appendChild(p);
    }
    ...
    function loadPurchaseStatus(){
      ...
      p.src='v34_purchase_status.js?v=46';
    ...
    s.src='v33_shopping_results.js?v=46';
  ...
  if(!loadV46()){
    let tries=0;
    const timer=setInterval(()=>{tries++;if(loadV46()||tries>80)clearInterval(timer)},125);
  }
})();
