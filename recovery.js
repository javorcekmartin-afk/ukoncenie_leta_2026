// v48 – bootstrap cloudu + všetky predchádzajúce vrstvy + jednotné skutočne minuté balenia + transparentné doplnkové náklady.
(function(){
  if(!document.getElementById('cloudBootstrapScript')){
    const s=document.createElement('script');
    s.id='cloudBootstrapScript';
    s.src='cloud_bootstrap.js?v=48';
  ...
  function loadV48(){
    ...
    function loadSupplementalClarity(){
      if(document.getElementById('v48SupplementalClarityScript'))return;
      const x=document.createElement('script');
      x.id='v48SupplementalClarityScript';
      x.src='v48_supplemental_cost_clarity.js?v=48';
      x.onload=()=>{document.title='Stánok v48';const pill=document.querySelector('.top .pill');if(pill)pill.textContent='v48';renderAll()};
    ...
    function loadLinkedActualPackages(){
      ...
      x.src='v47_linked_actual_packages.js?v=48';
    ...
    function loadShopActualUnits(){
      ...
      x.src='v46_shop_actual_units.js?v=48';
    ...
    function loadManualItemActual(){
      ...
      x.src='v45_manual_item_actual.js?v=48';
    ...
    function loadProfitInventory(){
      ...
      x.src='v44_profit_inventory_summary.js?v=48';
    ...
    function loadOpenPackageTargets(){
      ...
      x.src='v43_open_package_targets.js?v=48';
    ...
    function loadCategoryProfit(){
      ...
      x.src='v42_category_profit_only.js?v=48';
    ...
    function loadPrepaid(){
      ...
      x.src='v40_prepaid_before_event.js?v=48';
    ...
    function loadAllItems(){
      ...
      x.src='v39_all_items_in_shopping.js?v=48';
    ...
    function loadSelectiveProfit(){
      ...
      p.src='v38_selective_product_profit.js?v=48';
    ...
    function loadTruthful(){
      ...
      t.src='v37_truthful_results.js?v=48';
    ...
    function loadPlannedCosts(){
      ...
      p.src='v35_planned_costs.js?v=48';
      p.onload=loadVat;
      document.body.appendChild(p);
    }
    ...
    function loadPurchaseStatus(){
      ...
      p.src='v34_purchase_status.js?v=48';
    ...
    s.src='v33_shopping_results.js?v=48';
  ...
  if(!loadV48()){
    let tries=0;
    const timer=setInterval(()=>{tries++;if(loadV48()||tries>80)clearInterval(timer)},125);
  }
})();
