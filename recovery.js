// v49 – bootstrap cloudu + všetky predchádzajúce vrstvy + jednotné skutočne minuté balenia + čistý sumár skutočných cien podľa obchodov.
(function(){
  if(!document.getElementById('cloudBootstrapScript')){
    const s=document.createElement('script');
    s.id='cloudBootstrapScript';
    s.src='cloud_bootstrap.js?v=49';
  ...
  function loadV49(){
    ...
    function loadShopTotalCostOnly(){
      if(document.getElementById('v49ShopTotalCostOnlyScript'))return;
      const x=document.createElement('script');
      x.id='v49ShopTotalCostOnlyScript';
      x.src='v49_shop_total_cost_only.js?v=49';
      x.onload=()=>{document.title='Stánok v49';const pill=document.querySelector('.top .pill');if(pill)pill.textContent='v49';renderAll()};
      document.body.appendChild(x);
    }

    function loadSupplementalClarity(){
      if(document.getElementById('v48SupplementalClarityScript')){loadShopTotalCostOnly();return;}
      const x=document.createElement('script');
      x.id='v48SupplementalClarityScript';
      x.src='v48_supplemental_cost_clarity.js?v=49';
      x.onload=loadShopTotalCostOnly;
      document.body.appendChild(x);
    }

    function loadLinkedActualPackages(){
      if(document.getElementById('v47LinkedActualPackagesScript')){loadSupplementalClarity();return;}
      const x=document.createElement('script');
      x.id='v47LinkedActualPackagesScript';
      x.src='v47_linked_actual_packages.js?v=49';
      x.onload=loadSupplementalClarity;
      document.body.appendChild(x);
    }
    ...
    function loadShopActualUnits(){
      ...
      x.src='v46_shop_actual_units.js?v=49';
    ...
    function loadManualItemActual(){
      ...
      x.src='v45_manual_item_actual.js?v=49';
    ...
    function loadProfitInventory(){
      ...
      x.src='v44_profit_inventory_summary.js?v=49';
    ...
    function loadOpenPackageTargets(){
      ...
      x.src='v43_open_package_targets.js?v=49';
    ...
    function loadCategoryProfit(){
      ...
      x.src='v42_category_profit_only.js?v=49';
    ...
    function loadPrepaid(){
      ...
      x.src='v40_prepaid_before_event.js?v=49';
    ...
    function loadAllItems(){
      ...
      x.src='v39_all_items_in_shopping.js?v=49';
    ...
    function loadSelectiveProfit(){
      ...
      p.src='v38_selective_product_profit.js?v=49';
    ...
    function loadTruthful(){
      ...
      t.src='v37_truthful_results.js?v=49';
    ...
    function loadPlannedCosts(){
      ...
      p.src='v35_planned_costs.js?v=49';
      p.onload=loadVat;
      document.body.appendChild(p);
    }
    ...
    function loadPurchaseStatus(){
      ...
      p.src='v34_purchase_status.js?v=49';
    ...
    s.src='v33_shopping_results.js?v=49';
  ...
  if(!loadV49()){
    let tries=0;
    const timer=setInterval(()=>{tries++;if(loadV49()||tries>80)clearInterval(timer)},125);
  }
})();
